...
public enum SQLDataType {
	...
	public String ofLength(int l) { return toString() + '(' + l + ')'; }

	public String ofPrecision(int p) { return ofLength(p); }

	public String ofPrecisionAndScale(int p, int s) { return toString() + '(' + p + ',' + s + ')'; }
